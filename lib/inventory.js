...
var stock_piling = function(location,items){
  var stock_pile = {};
  var stock_pile_arr =[];
...
module.exports = {
  ...
  check : function(db,items,location,cb){
    var stock_pile_arr = stock_piling(location,items);
    var stock_availability = [];
    async.eachSeries(stock_pile_arr,
      function(item,ccb){
